...
class GPipeVGG16PipeLine(gpipe.PipeliningLayer):
    ...
    def __init__(self, params):
      ...
      batch_norm=p.batch_norm)
      p.pool2.Set(name='pool2',window_shape=p.window_shapes[0],window_stride=p.window_shapes[0])
      ...
      batch_norm=p.batch_norm)
      p.pool3.Set(name='pool3',window_shape=p.window_shapes[0],window_stride=p.window_shapes[0])
      ...
      batch_norm=p.batch_norm)
      p.pool4.Set(name='pool4',window_shape=p.window_shapes[0],window_stride=p.window_shapes[0])
      ...
      batch_norm=p.batch_norm)
      p.pool5.Set(name='pool5',window_shape=p.window_shapes[0],window_stride=p.window_shapes[0])
...
class GPipeImVGG16(base_layer.BaseLayer):
    @classmethod
    def Params(cls):
      p = super().Params()
