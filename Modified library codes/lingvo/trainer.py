...
tf.flags.DEFINE_integer('micro_num',1,'take the entire minibatch without splitting')
tf.flags.DEFINE_integer('num_partitions',1,'single partition by default')
tf.flags.DEFINE_list('layer_partitions',[],'default number of layers per partition')
tf.flags.DEFINE_integer('training_steps',200,'default number of training steps')
